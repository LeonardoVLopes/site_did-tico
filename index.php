...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="#">SimulaCiências</a>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <a href="calculo.php" class="btn btn-primary">Iniciar Simulado de Cálculo</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <a href="fisica.php" class="btn btn-primary">Iniciar Simulado de Física</a>
                    </div>
                </div>
            </div>
        </div>
